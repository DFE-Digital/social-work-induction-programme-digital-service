...
) : INotificationCommand
{
    ...
    )
    {
        ...
        async Task<NotificationResponse> GovNotifyCall()
        {
            ...
            catch (NotifyClientException ex)
            {
                ...
                return MapStatusCode(ex);
            }
        }
    }

    internal NotificationResponse ProcessFinalException(PolicyResult<NotificationResponse> result)
    {
    ...
    internal NotificationResponse MapStatusCode(NotifyClientException ex)
    {
