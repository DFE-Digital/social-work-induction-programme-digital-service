...
using SocialWorkInductionProgramme.Frontend.HttpClients.AuthService;
...
using SocialWorkInductionProgramme.Frontend.HttpClients.AuthService.Options;
...
using Xunit;
using Person = SocialWorkInductionProgramme.Frontend.HttpClients.AuthService.Models.Person;

namespace SocialWorkInductionProgramme.Frontend.Test.UnitTests.HttpClient.AuthServiceClientTests;
