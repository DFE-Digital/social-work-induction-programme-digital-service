...
const FRONTEND_SPEC_DIR =
	process.env.FRONTEND_SPEC_DIR || "./test/frontend-test/FunctionalTests";
const SWE_API_SPEC_DIR =
	process.env.SWE_API_SPEC_DIR ||
	"./test/swe-api-mimic-test/DfeSwwEcf.SweApiSimulator.Tests/FunctionalTests";
...
const specDirectory = isFrontend
	? FRONTEND_SPEC_DIR
	: isSweApi
		? SWE_API_SPEC_DIR
		: FRONTEND_SPEC_DIR;
			...
			"@serenity-js/playwright-test",
			{
				crew: [
					...
					[
						...
						{
							outputDirectory: `./test-results/serenity/${isFrontend ? "frontend" : "api"}`,
						},
					],
				],
			},
