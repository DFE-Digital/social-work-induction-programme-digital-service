...
using Respawn;
using SystemUser = SocialWorkInductionProgramme.Authentication.Core.DataStore.Postgres.Models.SystemUser;
...
public class DbHelper(string connectionString)
{
    ...
    public async Task ResetSchema()
    {
        ...
        var cachedMigrationsVersionPath = Path.Combine(
            ...
            "SocialWorkInductionProgramme.Authentication.Tests",
