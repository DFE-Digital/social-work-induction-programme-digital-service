...
namespace SocialWorkInductionProgramme.Authentication.Core.DataStore.Postgres.Migrations
{
    ...
    [Migration("20250303153944_AddOrganisationsAndPersonOrganisationsDateTimeDefaults")]
    partial class AddOrganisationsAndPersonOrganisationsDateTimeDefaults
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("SocialWorkInductionProgramme.Authentication.Core.DataStore.Postgres.Models.Event", b =>
                {
            ...
            modelBuilder.Entity("SocialWorkInductionProgramme.Authentication.Core.DataStore.Postgres.Models.JourneyState", b =>
                {
            ...
            modelBuilder.Entity("SocialWorkInductionProgramme.Authentication.Core.DataStore.Postgres.Models.NameSynonyms", b =>
                {
            ...
            modelBuilder.Entity("SocialWorkInductionProgramme.Authentication.Core.DataStore.Postgres.Models.OneLoginUser", b =>
                {
            ...
            modelBuilder.Entity("SocialWorkInductionProgramme.Authentication.Core.DataStore.Postgres.Models.Organisation", b =>
                {
            ...
            modelBuilder.Entity("SocialWorkInductionProgramme.Authentication.Core.DataStore.Postgres.Models.Person", b =>
                {
                    b.Property<Guid>("PersonId")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid")
            ...
            modelBuilder.Entity("SocialWorkInductionProgramme.Authentication.Core.DataStore.Postgres.Models.PersonOrganisation", b =>
                {
            ...
            modelBuilder.Entity("SocialWorkInductionProgramme.Authentication.Core.DataStore.Postgres.Models.PersonRole", b =>
                {
            ...
            modelBuilder.Entity("SocialWorkInductionProgramme.Authentication.Core.DataStore.Postgres.Models.PersonSearchAttribute", b =>
                {
            ...
            modelBuilder.Entity("SocialWorkInductionProgramme.Authentication.Core.DataStore.Postgres.Models.Role", b =>
                {
                    b.Property<int>("RoleId")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("integer")
            ...
            modelBuilder.Entity("SocialWorkInductionProgramme.Authentication.Core.DataStore.Postgres.Models.SupportTask", b =>
                {
            ...
            modelBuilder.Entity("SocialWorkInductionProgramme.Authentication.Core.DataStore.Postgres.Models.UserBase", b =>
                {
            ...
            modelBuilder.Entity("SocialWorkInductionProgramme.Authentication.Core.DataStore.Postgres.Models.SystemUser", b =>
                {
                    b.HasBaseType("SocialWorkInductionProgramme.Authentication.Core.DataStore.Postgres.Models.UserBase");
            ...
            modelBuilder.Entity("SocialWorkInductionProgramme.Authentication.Core.DataStore.Postgres.Models.User", b =>
                {
                    b.HasBaseType("SocialWorkInductionProgramme.Authentication.Core.DataStore.Postgres.Models.UserBase");
            ...
            modelBuilder.Entity("SocialWorkInductionProgramme.Authentication.Core.DataStore.Postgres.Models.OneLoginUser", b =>
                {
                    b.HasOne("SocialWorkInductionProgramme.Authentication.Core.DataStore.Postgres.Models.Person", "Person")
                        .WithOne()
                        .HasForeignKey("SocialWorkInductionProgramme.Authentication.Core.DataStore.Postgres.Models.OneLoginUser", "PersonId")
            ...
            modelBuilder.Entity("SocialWorkInductionProgramme.Authentication.Core.DataStore.Postgres.Models.PersonOrganisation", b =>
                {
                    b.HasOne("SocialWorkInductionProgramme.Authentication.Core.DataStore.Postgres.Models.Organisation", "Organisation")
            ...
            modelBuilder.Entity("SocialWorkInductionProgramme.Authentication.Core.DataStore.Postgres.Models.PersonRole", b =>
                {
                    ...
                    b.HasOne("SocialWorkInductionProgramme.Authentication.Core.DataStore.Postgres.Models.Role", "Role")
                        .WithMany("PersonRoles")
            ...
            modelBuilder.Entity("SocialWorkInductionProgramme.Authentication.Core.DataStore.Postgres.Models.SupportTask", b =>
                {
                    b.HasOne("SocialWorkInductionProgramme.Authentication.Core.DataStore.Postgres.Models.OneLoginUser", null)
                        .WithMany()
                        .HasForeignKey("OneLoginUserSubject")
                        .HasConstraintName("fk_support_tasks_one_login_user");

                    b.HasOne("SocialWorkInductionProgramme.Authentication.Core.DataStore.Postgres.Models.Person", null)
                        .WithMany()
                        .HasForeignKey("PersonId")
