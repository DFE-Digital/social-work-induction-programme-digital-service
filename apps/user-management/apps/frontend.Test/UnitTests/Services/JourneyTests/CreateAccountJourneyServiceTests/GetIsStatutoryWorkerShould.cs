...
public class GetIsStatutoryWorkerShould : CreateAccountJourneyServiceTestBase
{
    [Theory]
    [InlineData(true)]
    [InlineData(false)]
    public void WhenCalled_WithExistingSessionData_ReturnsAccountTypes(bool? expected)
    {
        ...
        HttpContext.Session.Set(
            ...
            new CreateAccountJourneyModel { IsStatutoryWorker = expected }
        );

        // Act
        var response = Sut.GetIsStatutoryWorker();
