...
public class SelectEthnicGroupAsianPageTests : SocialWorkerRegistrationPageTestBase
{
    ...
    public async Task OnGetAsync_WhenCalled_LoadsTheView()
    {
        ...
        MockRegisterSocialWorkerJourneyService.Setup(x => x.EthnicGroupService.GetEthnicGroupAsianAsync(PersonId)).ReturnsAsync(ethnicGroupAsian);
        MockRegisterSocialWorkerJourneyService.Setup(x => x.EthnicGroupService.GetOtherEthnicGroupAsianAsync(PersonId)).ReturnsAsync(otherEthnicGroupAsian);
        ...
        MockRegisterSocialWorkerJourneyService.Verify(x => x.EthnicGroupService.GetEthnicGroupAsianAsync(PersonId), Times.Once);
        MockRegisterSocialWorkerJourneyService.Verify(x => x.EthnicGroupService.GetOtherEthnicGroupAsianAsync(PersonId), Times.Once);
    ...
    public async Task OnPostAsync_WhenCalledWithValidValues_SavesValuesAndRedirectsUser()
    {
        ...
        MockAuthServiceClient.Verify(x => x.HttpContextService.GetPersonId(), Times.Once);
        MockRegisterSocialWorkerJourneyService.Verify(x => x.EthnicGroupService.SetEthnicGroupAsianAsync(PersonId, ethnicGroup), Times.Once);
        MockRegisterSocialWorkerJourneyService.Verify(x => x.EthnicGroupService.SetOtherEthnicGroupAsianAsync(PersonId, otherEthnicGroupAsian), Times.Once);
        VerifyAllNoOtherCalls();
    }
