...
public class UsersOperationsTests
{
    ...
    public async Task GetAll_SuccessfulRequest_ReturnsCorrectResponse()
    {
        ...
        // Act
        var response = await sut.Users.GetAllAsync(paginationRequest);
    ...
    public async Task GetAll_WhenErrorResponseReturned_ReturnsNull()
    {
        ...
        var actualException = await Assert.ThrowsAsync<InvalidOperationException>(
            async () => await sut.Users.GetAllAsync(paginationRequest)
        );
    ...
    public async Task GetById_SuccessfulRequest_ReturnsCorrectResponse()
    {
        ...
        // Act
        var response = await sut.Users.GetByIdAsync(personId);
    ...
    public async Task Create_SuccessfulRequest_ReturnsPerson()
    {
        ...
        var person = new Person
        {
            ...
            Status = new Faker().PickRandom<UserStatus>()
        };
        ...
        // Act
        var response = await sut.Users.CreateAsync(createRequest);
    ...
    public async Task Create_WhenErrorResponseReturned_ReturnsNull()
    {
        ...
        await Assert.ThrowsAsync<InvalidOperationException>(
            async () => await sut.Users.CreateAsync(createRequest)
        );
    ...
    public async Task Update_SuccessfulRequest_ReturnsPerson()
    {
        ...
        // Act
        var response = await sut.Users.UpdateAsync(updateRequest);
    ...
    public async Task Update_WhenErrorResponseReturned_ReturnsNull()
    {
        ...
        // Act
        await Assert.ThrowsAsync<InvalidOperationException>(
            async () => await sut.Users.UpdateAsync(updateRequest)
        );
