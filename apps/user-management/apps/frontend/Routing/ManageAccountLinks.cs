...
public class ManageAccountLinks(EcfLinkGenerator ecfLinkGenerator)
{
    ...
    public string EligibilitySocialWorkEnglandAsyeDropoutChange(Guid? organisationId = null) => ecfLinkGenerator.GetRequiredPathByPage("/ManageAccounts/EligibilitySocialWorkEnglandAsyeDropout", handler: "Change", routeValues: new { organisationId });
