...
# CONNECTIONSTRINGS__DEFAULTCONNECTION: e.g., "Host=...;Username=...;"
# DB_PASSWORD: The password for the database user.

## --- Input Validation ---
# Check if all three required arguments were provided.
if [ -z "$3" ]; then
  echo "Usage: $0 <database-name> <storage-account-name> <container-name>"
  exit 1
fi
...
BACKUP_FILE="${DATABASE_NAME}_${TIMESTAMP}.dump"
